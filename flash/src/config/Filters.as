package config {
	...
	public class Filters {
		...
		public static var menuOutLabel:Array = [new DropShadowFilter(1, 45, 0xFFFFFF, .5, 0, 0, 1.5, 1)];
		public static var menuOverLabel:Array = [new DropShadowFilter(1, -135, 0x000000, .35, 0, 0, 1.5, 1)];
		...
		public static var tabButtonSong:Array = [new DropShadowFilter(1, 90, 0x499162, 1.5, 2, 2, 1.5, 1)];
