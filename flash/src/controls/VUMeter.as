package controls {
	...
	public class VUMeter extends MorphSprite {
		...
		public function VUMeter(c:Object = null, d:String = DIRECTION_HORIZONTAL) {
			...
			// and get item size
			if(bd.width % TEMPLATE_LEDS != 0) throw new Error('Width of VUMeter skin has to be multiple of %u.');
		...
		public function blinkLed(setID:String, idx:uint):void {
			...
			if(idx < 0 || idx > $leds) throw new Error(sprintf('Invalid led index (%u)', idx));
